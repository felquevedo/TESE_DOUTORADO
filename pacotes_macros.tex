...
\newcommand{\imprimiranexopdf}[4]{
	\includepdf[pages=#3,pagecommand=\chapter{#2},scale=1,offset=0 -95]{#1}
...
\newcommand{\hl}{\underline{h_q}}
\newcommand{\hlvp}{\underline{h_q}^{vp}}
...
\newcommand{\dgdslvp}{\underline{g_{_\sigma}^{vp}}}
