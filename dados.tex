...
\tituloestrangeiro{Computational Analysis of Deformations in Deep Tunnels considering Plasticity-Viscoplastcity Coupling}
\local{Porto Alegre}
\data{2021}
...
\qualcoordenador{Lucas Festugato}
\qualtitcoordenador{Dr. pela Universidade Federal do Rio Grande do Sul}
