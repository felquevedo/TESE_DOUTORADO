...
\include{./chap/Introducao}
\include{./chap/Diretrizes_da_pesquisa}
\include{./chap/Estado_da_arte}
\include{./chap/Comportamento_mecanico_de_tuneis}
\include{./chap/Modelo_mecanico}
\include{./chap/Solucao_do_modelo_mecanico}
\include{./chap/Algumas_verificacoes_validacoes}
\include{./chap/Conclusoes}
%
