...
Agradeço ao suporte ténico da \textit{Engineering Simulation and Scientific Software} (ESSS) pela assistência técnica frente às dúvidas relacionadas à utilização e customização do \textit{software} ANSYS.
