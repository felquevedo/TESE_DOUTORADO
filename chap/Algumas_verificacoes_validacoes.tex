...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.2]{0703-lei de endurecimento ou amolecimento_coesao_solucao_analitca.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0704-lei de endurecimento ou amolecimento_coesao_solucao_numerica.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0705-AXI-SREVESTIMENTO-E1000.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0706-AXI-SREVESTIMENTO-E5000.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0707-AXI-SREVESTIMENTO-E1000-ER30000-D0.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0708-AXI-SREVESTIMENTO-E1000-ER30000-D4.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0709-AXI-PLAST-SREVESTIMENTO-D0-E1000-ER0-P4-C1.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1]{0710-AXI-PLAST-SREVESTIMENTO-D0-E1000-ER0-P4-C3.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1]{0711-AXI-PLAST--D0-E1000-ER0-P4-C1-KP15-KB1.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0712-PLAST-D0-E1000-ER30000-P4-C1.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0713-AXI-D0-E1000-ER0-P4-C1-V5.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0714-AXI-D0-E1000-ER0-P4-C1-V10.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0715-AXI-D2-E1000-ER3000-P4-C1-V5.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0716-PIEPI-E1500-FINALESCAVACAO.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0717-PIEPI-E1500-LONGOPRAZO.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0718-PIEPI-E2000-FINALESCAVACAO.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0719-PIEPI-E2000-LONGOPRAZO.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0720-PIEPI-E1500-CAMPO_DESLOCAMENTO.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0721-PIEPI-E1500-CAMPO_DEFORMACOES.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1]{0722-VP_COMPARAÇÃO_SOLUÇÃO_NUMÉRICA_CONVERGENCIA.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1]{0723-EPVP_COMPARAÇÃO_SOLUÇÃO_NUMÉRICA_CONVERGENCIA.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1]{0724-AMOLECIMENTO.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0725-EP-EFEITO-AMOLECIMENTO.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0726-EPVP-EFEITO-AMOLECIMENTO.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0727-PARAMETRICO-D0-FINALCONSTRUÇÃO.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0728-PARAMETRICO-D0-LONGOPRAZO.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0729-PARAMETRICO-D4-FINALCONSTRUÇÃO.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0730-PARAMETRICO-D4-LONGOPRAZO.pdf
		}
	\end{center}
...
Esses resultados indicam que, para os parâmetros utilizados, o modelo acoplado tem maiores diferenças no curto prazo e na presença de revestimento.
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0731-ELIPTICO-CONVERGENCIAS-UX-SREV.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0732-ELIPTICO-CONVERGENCIAS-UX-CREV.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0733-ELIPTICO-CONVERGENCIAS-UY-SREV.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0734-ELIPTICO-CONVERGENCIAS-UY-CREV.pdf
		}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0735-campo_deformacoes_eliptico.pdf
		}
	\end{center}
