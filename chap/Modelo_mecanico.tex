...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0511-representação reológica.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0512-lei de endurecimento ou amolecimento.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0513-dominios_superficie_epvp.pdf}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale = 1.0]{0514-resposta_epvp_deformacao_constante.pdf}
	\end{center}
