...
\end{equation}
As derivadas parciais na expressão acima, conforme (\ref{eq:f_Mohr_Coulomb}) e (\ref{eq:f_Drucker_Prager}), ficam sendo
\begin{equation}
	\label{eq:dfdc}
